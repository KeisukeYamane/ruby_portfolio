...
ActiveRecord::Schema.define(version: 20191108235738) do

  create_table "favorites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci" do |t|
    t.integer "user_id"
    t.integer "post_id"
